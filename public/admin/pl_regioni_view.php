...
$layout->blocks["top"][] = "details";$page_layouts["pl_regioni_view"] = $layout;
...
$arr = array();
$arr['fName'] = "regione";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("regione");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "nome_it";
...
//regione - 
	...
	if($mainTableOwnerID=="regione")
		$ownerIdValue=$value;
	$xt->assign("regione_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='pl_regioni_edit.php?".$editlink."'\"");
