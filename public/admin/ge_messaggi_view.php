...
$layout->blocks["top"][] = "details";$page_layouts["ge_messaggi_view"] = $layout;
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='ge_messaggi_edit.php?".$editlink."'\"");
