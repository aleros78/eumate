...
$layout->blocks["top"][] = "pdf";$page_layouts["pl_regioni_print"] = $layout;
...
//	regione - 
			$record["regione_value"] = $pageObject->showDBValue("regione", $data, $keylink);
			$record["regione_class"] = $pageObject->fieldClass("regione");
//	nome_it - 
...
$xt->assign("regione_fieldheadercolumn",true);
$xt->assign("regione_fieldheader",true);
$xt->assign("regione_fieldcolumn",true);
$xt->assign("regione_fieldfootercolumn",true);
