...
$layout->blocks["top"][] = "search";$page_layouts["ge_utenti_list"] = $layout;
...
$layout->blocks["bare"][] = "mastergrid";$page_layouts["vv_tipologia_utenti_masterlist"] = $layout;

$layout = GetPageLayout("vv_tipologia_utenti", 'masterlist');
if($layout)
{
...
$viewControls = new ViewControlsContainer(new ProjectSettings("vv_tipologia_utenti", PAGE_LIST), PAGE_LIST);
