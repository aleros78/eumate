...
$layout->blocks["top"][] = "details";$page_layouts["pg_gilde_view"] = $layout;
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='pg_gilde_edit.php?".$editlink."'\"");
