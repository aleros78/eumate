...
$layout->blocks["top"][] = "pdf";$page_layouts["pl_riferimenti_posti_print"] = $layout;
...
//	id_posto_riferimento - 
			$record["id_posto_riferimento_value"] = $pageObject->showDBValue("id_posto_riferimento", $data, $keylink);
			$record["id_posto_riferimento_class"] = $pageObject->fieldClass("id_posto_riferimento");
			if($col<$colsonpage)
...
//	include proper masterprint.php code
	...
	$params = array("detailtable"=>"pl_riferimenti_posti","keys"=>$masterkeys);
	$master = array();
...
$xt->assign("id_posto_riferimento_fieldheadercolumn",true);
$xt->assign("id_posto_riferimento_fieldheader",true);
$xt->assign("id_posto_riferimento_fieldcolumn",true);
$xt->assign("id_posto_riferimento_fieldfootercolumn",true);
