...
$layout->blocks["top"][] = "pdf";$page_layouts["vv_tipologia_utenti_print"] = $layout;
...
//	tipologia - 
			$record["tipologia_value"] = $pageObject->showDBValue("tipologia", $data, $keylink);
			$record["tipologia_class"] = $pageObject->fieldClass("tipologia");
			if($col<$colsonpage)
...
$xt->assign("tipologia_fieldheadercolumn",true);
$xt->assign("tipologia_fieldheader",true);
$xt->assign("tipologia_fieldcolumn",true);
$xt->assign("tipologia_fieldfootercolumn",true);
