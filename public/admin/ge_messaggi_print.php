...
$layout->blocks["top"][] = "pdf";$page_layouts["ge_messaggi_print"] = $layout;
...
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "id_personaggio";
$arr['viewFormat'] = $pageObject->pSet->getViewFormat("id_personaggio");
$fieldsArr[] = $arr;
$arr = array();
$arr['fName'] = "id_gilda";
...
//	id_personaggio - 
			$record["id_personaggio_value"] = $pageObject->showDBValue("id_personaggio", $data, $keylink);
			$record["id_personaggio_class"] = $pageObject->fieldClass("id_personaggio");
//	id_gilda - 
...
//	include proper masterprint.php code
	...
	$params = array("detailtable"=>"ge_messaggi","keys"=>$masterkeys);
	$master = array();
...
$xt->assign("id_personaggio_fieldheadercolumn",true);
$xt->assign("id_personaggio_fieldheader",true);
$xt->assign("id_personaggio_fieldcolumn",true);
$xt->assign("id_personaggio_fieldfootercolumn",true);
