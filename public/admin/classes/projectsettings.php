...
function GetTableURL($table = "")
{
	...
	if("pg_gilde" == $table) 
		return "pg_gilde";
	if("pl_locations" == $table) 
		return "pl_locations";
	if("pg_personaggi" == $table) 
		return "pg_personaggi";
	if("pl_citta" == $table) 
		return "pl_citta";
	if("pl_posti" == $table) 
		return "pl_posti";
	if("pl_regioni" == $table) 
		return "pl_regioni";
	if("pl_riferimenti_posti" == $table) 
		return "pl_riferimenti_posti";
	if("vv_azioni_lista" == $table) 
		return "vv_azioni_lista";
	if("vv_config_var" == $table) 
...
{	
	...
	if("ge_utenti" == $shortTName) 
		return "ge_utenti";
	if("pg_mail" == $shortTName) 
		return "pg_mail";
	if("pg_gilde" == $shortTName) 
		return "pg_gilde";
	if("pl_locations" == $shortTName) 
		return "pl_locations";
	if("pg_personaggi" == $shortTName) 
		return "pg_personaggi";
	if("pl_citta" == $shortTName) 
		return "pl_citta";
	if("pl_posti" == $shortTName) 
		return "pl_posti";
	if("pl_regioni" == $shortTName) 
		return "pl_regioni";
	if("pl_riferimenti_posti" == $shortTName) 
		return "pl_riferimenti_posti";
	if("vv_azioni_lista" == $shortTName) 
		return "vv_azioni_lista";
	if("vv_config_var" == $shortTName) 
		return "vv_config_var";
