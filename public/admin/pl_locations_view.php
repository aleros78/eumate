...
$layout->blocks["top"][] = "details";$page_layouts["pl_locations_view"] = $layout;
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='pl_locations_edit.php?".$editlink."'\"");
