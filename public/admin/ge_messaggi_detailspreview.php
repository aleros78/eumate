...
$layout->blocks["bare"][] = "detailspreviewgrid";$page_layouts["ge_messaggi_detailspreview"] = $layout;
...
{
	$where = "";
		$where .= GetFullFieldName("id_personaggio", $strTableName, false)."=".make_db_value("id_personaggio",$_SESSION[$strTableName."_masterkey1"]);
}
...
if($rowcount) {
	...
	//	id_personaggio - 
			$viewContainer->recId = $recordsCounter;
		    $value = $viewContainer->showDBValue("id_personaggio", $data, $keylink);
			$row["id_personaggio_value"] = $value;
	//	id_gilda - 
			$viewContainer->recId = $recordsCounter;
...
$xt->load_template("ge_messaggi_detailspreview.htm");
