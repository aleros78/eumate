...
$layout->blocks["top"][] = "details";$page_layouts["pg_messaggi_edit"] = $layout;
...
$templatefile = "pg_messaggi_edit.htm";
...
if ($IsSaved && no_output_done() && $inlineedit == EDIT_SIMPLE)
{
	...
	// redirect
	header("Location: pg_messaggi_".$pageObject->getPageType().".php?".$keyGetQ);
...
if(!$data)
{
	...
	{
		header("Location: pg_messaggi_list.php?a=return");
		exit();
	}
	else
		$data = array();
...
$xt->assign("viewlink_attrs","id=\"viewButton".$id."\" name=\"viewButton".$id."\" onclick=\"window.location.href='pg_messaggi_view.php?".$viewlink."'\"");
