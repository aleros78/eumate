...
$layout->blocks["top"][] = "pdf";$page_layouts["vv_azioni_lista_print"] = $layout;
...
//	azione - 
			$record["azione_value"] = $pageObject->showDBValue("azione", $data, $keylink);
			$record["azione_class"] = $pageObject->fieldClass("azione");
//	descrizione - 
			$record["descrizione_value"] = $pageObject->showDBValue("descrizione", $data, $keylink);
			$record["descrizione_class"] = $pageObject->fieldClass("descrizione");
			if($col<$colsonpage)
...
$xt->assign("azione_fieldheadercolumn",true);
$xt->assign("azione_fieldheader",true);
$xt->assign("azione_fieldcolumn",true);
$xt->assign("azione_fieldfootercolumn",true);
$xt->assign("descrizione_fieldheadercolumn",true);
$xt->assign("descrizione_fieldheader",true);
$xt->assign("descrizione_fieldcolumn",true);
$xt->assign("descrizione_fieldfootercolumn",true);
