<?php
include_once(getabspath("include/pg_gilde_settings.php"));

function DisplayMasterTableInfo_pg_gilde($params)
{
...
//$strSQL = "SELECT id,   nome,   descrizione,   attivo  FROM pg_gilde ";
...
//	descrizione - 
			$xt->assign("descrizione_mastervalue", $viewControls->showDBValue("descrizione", $data, $keylink));

//	attivo - Checkbox
			$xt->assign("attivo_mastervalue", $viewControls->showDBValue("attivo", $data, $keylink));
	$xt->display("pg_gilde_masterprint.htm");
	$strTableName=$oldTableName;
