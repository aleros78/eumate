...
class tDAL
{
	...
	function FillTablesList()
	{
	  ...
	  $this->lstTables[]=array("name"=>"pg_gilde","varname"=>"pg_gilde");
	  $this->lstTables[]=array("name"=>"pl_locations","varname"=>"pl_locations");
	  $this->lstTables[]=array("name"=>"pg_personaggi","varname"=>"pg_personaggi");
	  $this->lstTables[]=array("name"=>"pl_citta","varname"=>"pl_citta");
	  $this->lstTables[]=array("name"=>"pl_posti","varname"=>"pl_posti");
	  $this->lstTables[]=array("name"=>"pl_regioni","varname"=>"pl_regioni");
	  $this->lstTables[]=array("name"=>"pl_riferimenti_posti","varname"=>"pl_riferimenti_posti");
