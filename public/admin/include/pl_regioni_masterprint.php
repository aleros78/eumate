<?php
include_once(getabspath("include/pl_regioni_settings.php"));

function DisplayMasterTableInfo_pl_regioni($params)
{
...
//$strSQL = "SELECT id,   regione,   nome_it,   nome_en,   descrizione_it,   descrizione_en,   storia_it,   storia_en,   back_it,   back_en,   note_it,   note_en,   attivo  FROM pl_regioni ";
...
//	regione - 
			$xt->assign("regione_mastervalue", $viewControls->showDBValue("regione", $data, $keylink));
...
//	attivo - Checkbox
	...
	$xt->display("pl_regioni_masterprint.htm");
	$strTableName=$oldTableName;
