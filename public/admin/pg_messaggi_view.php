...
$layout->blocks["top"][] = "details";$page_layouts["pg_messaggi_view"] = $layout;
...
//id_personaggio - 
	...
	if($mainTableOwnerID=="id_personaggio")
		$ownerIdValue=$value;
	$xt->assign("id_personaggio_value",$value);
...
//messaggio - 
	...
	if($mainTableOwnerID=="messaggio")
		$ownerIdValue=$value;
	$xt->assign("messaggio_value",$value);
...
//data - Short Date
	...
	if($mainTableOwnerID=="data")
		$ownerIdValue=$value;
	$xt->assign("data_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='pg_messaggi_edit.php?".$editlink."'\"");
