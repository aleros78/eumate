...
$layout->blocks["top"][] = "details";$page_layouts["pg_gilde_edit"] = $layout;
...
$templatefile = ($inlineedit == EDIT_INLINE) ? "pg_gilde_inline_edit.htm" : "pg_gilde_edit.htm";
...
if ($IsSaved && no_output_done() && $inlineedit == EDIT_SIMPLE)
{
	...
	// redirect
	header("Location: pg_gilde_".$pageObject->getPageType().".php?".$keyGetQ);
...
if(!$data)
{
	...
	{
		header("Location: pg_gilde_list.php?a=return");
		exit();
	}
	else
		$data = array();
...
$xt->assign("viewlink_attrs","id=\"viewButton".$id."\" name=\"viewButton".$id."\" onclick=\"window.location.href='pg_gilde_view.php?".$viewlink."'\"");
