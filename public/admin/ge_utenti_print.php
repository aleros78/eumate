...
$layout->blocks["top"][] = "pdf";$page_layouts["ge_utenti_print"] = $layout;
...
//	id_tipologia - 
			$record["id_tipologia_value"] = $pageObject->showDBValue("id_tipologia", $data, $keylink);
			$record["id_tipologia_class"] = $pageObject->fieldClass("id_tipologia");
//	nome - 
			$record["nome_value"] = $pageObject->showDBValue("nome", $data, $keylink);
			$record["nome_class"] = $pageObject->fieldClass("nome");
//	cognome - 
			$record["cognome_value"] = $pageObject->showDBValue("cognome", $data, $keylink);
			$record["cognome_class"] = $pageObject->fieldClass("cognome");
//	email - 
...
//	data_registrazione - Short Date
			$record["data_registrazione_value"] = $pageObject->showDBValue("data_registrazione", $data, $keylink);
			$record["data_registrazione_class"] = $pageObject->fieldClass("data_registrazione");
//	ip_registrazione - 
			$record["ip_registrazione_value"] = $pageObject->showDBValue("ip_registrazione", $data, $keylink);
			$record["ip_registrazione_class"] = $pageObject->fieldClass("ip_registrazione");
//	numero_login - 
			$record["numero_login_value"] = $pageObject->showDBValue("numero_login", $data, $keylink);
			$record["numero_login_class"] = $pageObject->fieldClass("numero_login");
//	ip_ultimo_login - 
			$record["ip_ultimo_login_value"] = $pageObject->showDBValue("ip_ultimo_login", $data, $keylink);
			$record["ip_ultimo_login_class"] = $pageObject->fieldClass("ip_ultimo_login");
//	attivo - Checkbox
...
//	include proper masterprint.php code
	include("include/vv_tipologia_utenti_masterprint.php");
	$masterkeys[] = @$_SESSION[$strTableName."_masterkey1"];
	$params = array("detailtable"=>"ge_utenti","keys"=>$masterkeys);
	$master = array();
	$master["func"] = "DisplayMasterTableInfo_vv_tipologia_utenti";
...
$layout->blocks["bare"][] = "mastergrid";$page_layouts["vv_tipologia_utenti_masterprint"] = $layout;

	$layout = GetPageLayout("vv_tipologia_utenti", 'masterprint');
	if($layout)
	{
...
$xt->assign("id_tipologia_fieldheadercolumn",true);
$xt->assign("id_tipologia_fieldheader",true);
$xt->assign("id_tipologia_fieldcolumn",true);
$xt->assign("id_tipologia_fieldfootercolumn",true);
...
$xt->assign("cognome_fieldheadercolumn",true);
$xt->assign("cognome_fieldheader",true);
$xt->assign("cognome_fieldcolumn",true);
$xt->assign("cognome_fieldfootercolumn",true);
...
$xt->assign("data_registrazione_fieldheadercolumn",true);
$xt->assign("data_registrazione_fieldheader",true);
$xt->assign("data_registrazione_fieldcolumn",true);
$xt->assign("data_registrazione_fieldfootercolumn",true);
$xt->assign("ip_registrazione_fieldheadercolumn",true);
$xt->assign("ip_registrazione_fieldheader",true);
$xt->assign("ip_registrazione_fieldcolumn",true);
$xt->assign("ip_registrazione_fieldfootercolumn",true);
$xt->assign("numero_login_fieldheadercolumn",true);
$xt->assign("numero_login_fieldheader",true);
$xt->assign("numero_login_fieldcolumn",true);
$xt->assign("numero_login_fieldfootercolumn",true);
$xt->assign("ip_ultimo_login_fieldheadercolumn",true);
$xt->assign("ip_ultimo_login_fieldheader",true);
$xt->assign("ip_ultimo_login_fieldcolumn",true);
$xt->assign("ip_ultimo_login_fieldfootercolumn",true);
