...
$layout->blocks["top"][] = "pdf";$page_layouts["pl_citta_print"] = $layout;
...
//	citta - 
			$record["citta_value"] = $pageObject->showDBValue("citta", $data, $keylink);
			$record["citta_class"] = $pageObject->fieldClass("citta");
//	nome_it - 
...
//	include proper masterprint.php code
	...
	$params = array("detailtable"=>"pl_citta","keys"=>$masterkeys);
	$master = array();
...
$xt->assign("citta_fieldheadercolumn",true);
$xt->assign("citta_fieldheader",true);
$xt->assign("citta_fieldcolumn",true);
$xt->assign("citta_fieldfootercolumn",true);
