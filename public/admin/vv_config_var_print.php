...
$layout->blocks["top"][] = "pdf";$page_layouts["vv_config_var_print"] = $layout;
...
//	key - 
			$record["key_value"] = $pageObject->showDBValue("key", $data, $keylink);
			$record["key_class"] = $pageObject->fieldClass("key");
//	value - 
			$record["value_value"] = $pageObject->showDBValue("value", $data, $keylink);
			$record["value_class"] = $pageObject->fieldClass("value");
//	note - 
...
$xt->assign("key_fieldheadercolumn",true);
$xt->assign("key_fieldheader",true);
$xt->assign("key_fieldcolumn",true);
$xt->assign("key_fieldfootercolumn",true);
$xt->assign("value_fieldheadercolumn",true);
$xt->assign("value_fieldheader",true);
$xt->assign("value_fieldcolumn",true);
$xt->assign("value_fieldfootercolumn",true);
