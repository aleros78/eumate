...
$layout->blocks["top"][] = "details";$page_layouts["ge_utenti_edit"] = $layout;
...
//	processing id_tipologia - begin
	...
	if($condition)
	{
		...
		$control_id_tipologia->readWebValue($evalues, $blobfields, $strWhereClause, $oldValuesRead, $efilename_values);
...
//	processing cognome - begin
	...
	if($condition)
	{
		...
		$control_cognome->readWebValue($evalues, $blobfields, $strWhereClause, $oldValuesRead, $efilename_values);
...
//	processing data_registrazione - begin
	...
	if($condition)
	{
		...
		$control_data_registrazione->readWebValue($evalues, $blobfields, $strWhereClause, $oldValuesRead, $efilename_values);
...
//	processing ip_registrazione - begin
	...
	if($condition)
	{
		...
		$control_ip_registrazione->readWebValue($evalues, $blobfields, $strWhereClause, $oldValuesRead, $efilename_values);
...
//	processing numero_login - begin
	...
	if($condition)
	{
		...
		$control_numero_login->readWebValue($evalues, $blobfields, $strWhereClause, $oldValuesRead, $efilename_values);
...
//	processing ip_ultimo_login - begin
	...
	if($condition)
	{
		...
		$control_ip_ultimo_login->readWebValue($evalues, $blobfields, $strWhereClause, $oldValuesRead, $efilename_values);
...
if ($IsSaved && no_output_done() && $inlineedit == EDIT_SIMPLE)
{
	...
	// redirect
	header("Location: ge_utenti_".$pageObject->getPageType().".php?".$keyGetQ);
...
if($readevalues)
{
	$data["id_tipologia"] = $evalues["id_tipologia"];
	$data["nome"] = $evalues["nome"];
	$data["cognome"] = $evalues["cognome"];
	$data["email"] = $evalues["email"];
	$data["password"] = $evalues["password"];
	$data["data_registrazione"] = $evalues["data_registrazione"];
	$data["ip_registrazione"] = $evalues["ip_registrazione"];
	$data["numero_login"] = $evalues["numero_login"];
	$data["ip_ultimo_login"] = $evalues["ip_ultimo_login"];
...
if($inlineedit != EDIT_INLINE)
{
	...
	if(isEnableSection508())
		$xt->assign_section("id_tipologia_label","<label for=\"".GetInputElementId("id_tipologia", $id, PAGE_EDIT)."\">","</label>");
	...
	if(isEnableSection508())
		$xt->assign_section("cognome_label","<label for=\"".GetInputElementId("cognome", $id, PAGE_EDIT)."\">","</label>");
	...
	if(isEnableSection508())
		$xt->assign_section("data_registrazione_label","<label for=\"".GetInputElementId("data_registrazione", $id, PAGE_EDIT)."\">","</label>");
	...
	if(isEnableSection508())
		$xt->assign_section("ip_registrazione_label","<label for=\"".GetInputElementId("ip_registrazione", $id, PAGE_EDIT)."\">","</label>");
	...
	if(isEnableSection508())
		$xt->assign_section("numero_login_label","<label for=\"".GetInputElementId("numero_login", $id, PAGE_EDIT)."\">","</label>");
	...
	if(isEnableSection508())
		$xt->assign_section("ip_ultimo_login_label","<label for=\"".GetInputElementId("ip_ultimo_login", $id, PAGE_EDIT)."\">","</label>");
...
$xt->assign("viewlink_attrs","id=\"viewButton".$id."\" name=\"viewButton".$id."\" onclick=\"window.location.href='ge_utenti_view.php?".$viewlink."'\"");
