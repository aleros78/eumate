...
$layout->blocks["top"][] = "search";$page_layouts["ge_messaggi_list"] = $layout;
...
$layout = GetPageLayout("pg_gilde", 'masterlist');
if($layout)
{
...
$viewControls = new ViewControlsContainer(new ProjectSettings("pg_gilde", PAGE_LIST), PAGE_LIST);
...
include_once getabspath('classes/controls/ViewControlsContainer.php');
$viewControls = new ViewControlsContainer(new ProjectSettings("pg_personaggi", PAGE_LIST), PAGE_LIST);
$viewControls->addControlsJSAndCSS();
$pageObject->includes_js = array_merge($pageObject->includes_js, $viewControls->includes_js);
$pageObject->includes_jsreq = array_merge($pageObject->includes_jsreq, $viewControls->includes_jsreq);
$pageObject->includes_css = array_merge($pageObject->includes_css, $viewControls->includes_css);
...
include_once getabspath('classes/controls/ViewControlsContainer.php');
$viewControls = new ViewControlsContainer(new ProjectSettings("pl_posti", PAGE_LIST), PAGE_LIST);
$viewControls->addControlsJSAndCSS();
$pageObject->includes_js = array_merge($pageObject->includes_js, $viewControls->includes_js);
$pageObject->includes_jsreq = array_merge($pageObject->includes_jsreq, $viewControls->includes_jsreq);
$pageObject->includes_css = array_merge($pageObject->includes_css, $viewControls->includes_css);
