...
$layout->blocks["top"][] = "details";$page_layouts["pl_posti_view"] = $layout;
...
//id_location - 
	...
	if($mainTableOwnerID=="id_location")
		$ownerIdValue=$value;
	$xt->assign("id_location_value",$value);
...
//id_citta - 
	...
	if($mainTableOwnerID=="id_citta")
		$ownerIdValue=$value;
	$xt->assign("id_citta_value",$value);
...
//posto - 
	...
	if($mainTableOwnerID=="posto")
		$ownerIdValue=$value;
	$xt->assign("posto_value",$value);
...
$xt->assign("editlink_attrs","id=\"editLink".$id."\" name=\"editLink".$id."\" onclick=\"window.location.href='pl_posti_edit.php?".$editlink."'\"");
